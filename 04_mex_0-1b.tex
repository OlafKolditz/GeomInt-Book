\section[MEX 0-1b: Bending fracture test (OPA)]{Model-Experiments-Exercise MEX 0-1b (01):\\Bending fracture test (OPA)}
\label{sec:mex01b}
...
The simulations by VPF show similar trends observed in the lattice model.
