...
\hline
%
Data label & GeomInt | CAU | Data set Fracture Toughness-Granite \\
URI &  https://nextcloud.ifg.uni-kiel.de/index.php/s/pRmBPJ9gK5Se6ci\\
Subject  &  Fracture Toughness Simulation\\
...
\begin{table}[!ht]
\caption{MEX 0-1b: Bending fracture test on Opalinus Claystone}
\label{tab:dms-mex3-3}
\small
\begin{tabular}{R{3cm}|L{7cm}}
\hline
%
Data label & GeomInt | CAU | Data set Fracture Toughness-Opalinus Claystone \\
URI &  https://nextcloud.ifg.uni-kiel.de/index.php/s/pJxp2eNEJb6PfiS (Experiments), https://nextcloud.ifg.uni-kiel.de/index.php/s/ZBFN2rSZ99kPY9M (Simulation)\\
Subject  &  Fracture Toughness Simulation\\
