...
The load and crack mouth opening displacment computed from the simulations are shown in
in section \ref {sec:mex01b}.
\subsection{MEX 1-1a:}
...
%Figure \ref{fig:fig:Amir_ME2_LEM_a_model_Frack_Data} shows the relation between the load vs. CMOD as described in section \ref {sec:mex01}.

%\begin{figure}[!ht]
%\centering
%\includegraphics[width=0.75\textwidth]{figures/Amir_ME2_LEM_a%_model_Frack_Data.png}
%\caption{The fracking surfaces shown in red}
%\label{fig:Amir_ME2_LEM_a_model_Frack_Data}
%\end{figure}
