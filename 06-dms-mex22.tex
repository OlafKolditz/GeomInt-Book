...
\hline
EXP  & LAB   & IfG   & Limited    & Available on demand           & \cellcolor{yellow} \\
\hline \hline
MOD  & DEM   & IfG   & License    & Commercial code               & \cellcolor{green} \\
     &       &       & Restricted & I/O: Available on demand      & \cellcolor{yellow} \\
\hline
MOD  & FEM   & UFZ   & Open source & via OpenGeoSys portal        & \cellcolor{yellow} \\
     & VPF   &       & Free       & I/O Available                 & \cellcolor{green} \\
%
\hline
\end{tabular}
\end{table}
