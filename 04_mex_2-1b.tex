...
Using the variational phase-field model presented in this study, impacts of the anisotropy induced by the lamination parallel and orhtogonal of the Opalinus claystone were studied through 3D computational domains (Figs~\ref{fig:VPF_ME2_B_init}
